...
<br><br> **الأعمدة:** عدد البيانات الوصفية والاكلينية التي تم جمعها.
<br><br> **الصفوف:** عدد المرضى.
...
#عمود يحتوي على قيمة واحدة فقط لكل المرضي
...
🔵 New tumor events after treatment information:
...
🔵 Histological types of breast tumors:
...
🔵 Pathological stage of breast tumors:
...
save_path <- "H:/Other computers/My Laptop (1)/Google Drive/dALLAH/Collab/Talent_health_info/health-info-bioinformatics-r/metadata/"

write.csv(Breast_tumor_metadata, paste0(save_path,"Breast_tumor_metadata_cleaned.csv"))
